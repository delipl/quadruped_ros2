...
class ImpedanceControllerNode(Node):
    ...
    def joint_state_callback(self, msg):
        ...
        new_theta2 = self.q["front_left_fifth_joint"]
        new_omega_2 = self.v["front_left_fifth_joint"]
        new_epsilon_2 = self.tau["front_left_fifth_joint"]
        ...
        new_kinematic_values["theta1"] = np.pi
