...
#ifndef TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_QUADRUPED_CONTROLLER_HPP_
#define TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_QUADRUPED_CONTROLLER_HPP_
...
using ControllerStateMsg = quadruped_controller::QuadrupedController::ControllerStateMsg;
using ControllerReferenceMsg = quadruped_controller::QuadrupedController::ControllerReferenceMsg;
using ControllerModeSrvType = quadruped_controller::QuadrupedController::ControllerModeSrvType;
...
class TestableQuadrupedController : public quadruped_controller::QuadrupedController
{
  FRIEND_TEST(QuadrupedControllerTest, all_parameters_set_configure_success);
  FRIEND_TEST(QuadrupedControllerTest, activate_success);
  FRIEND_TEST(QuadrupedControllerTest, reactivate_success);
  FRIEND_TEST(QuadrupedControllerTest, test_setting_slow_mode_service);
  FRIEND_TEST(QuadrupedControllerTest, test_update_logic_fast);
  FRIEND_TEST(QuadrupedControllerTest, test_update_logic_slow);
  FRIEND_TEST(QuadrupedControllerTest, test_update_logic_chainable_fast);
  FRIEND_TEST(QuadrupedControllerTest, test_update_logic_chainable_slow);

public:
  controller_interface::CallbackReturn on_configure(
    const rclcpp_lifecycle::State & previous_state) override
  {
    auto ret = quadruped_controller::QuadrupedController::on_configure(previous_state);
    ...
    const rclcpp_lifecycle::State & previous_state) override
  {
    ...
    return quadruped_controller::QuadrupedController::on_activate(previous_state);
  }
...
class QuadrupedControllerFixture : public ::testing::Test
{
public:
  ...
  void SetUp()
  {
    ...
    command_publisher_ = command_publisher_node_->create_publisher<ControllerReferenceMsg>(
      "/test_quadruped_controller/commands", rclcpp::SystemDefaultsQoS());
    ...
    slow_control_service_client_ = service_caller_node_->create_client<ControllerModeSrvType>(
      "/test_quadruped_controller/set_slow_control_mode");
  }
...
protected:
  void SetUpController(const std::string controller_name = "test_quadruped_controller")
  {
  ...
  void subscribe_and_get_messages(ControllerStateMsg & msg)
  {
    ...
    auto subscription = test_subscription_node.create_subscription<ControllerStateMsg>(
      "/test_quadruped_controller/state", 10, subs_callback);
...
protected:
  ...
  std::unique_ptr<TestableQuadrupedController> controller_;
...
#endif  // TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_QUADRUPED_CONTROLLER_HPP_
