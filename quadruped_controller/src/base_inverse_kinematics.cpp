...
public:
  ...
  {
    quadruped_control_pub_ = this->create_publisher<quadruped_msgs::msg::QuadrupedControl>(
    ...
    base_pose_sub_ = this->create_subscription<geometry_msgs::msg::PoseStamped>(
      ...
      std::bind(&BaseInverseKinematics::base_pose_callback, this, std::placeholders::_1));
...
private:
    ...
    const geometry_msgs::msg::PoseStamped::SharedPtr msg)
  {
    ...
    quad_control.fl_foot_position.x = default_leg_separation_x - msg->pose.position.x;
    quad_control.fl_foot_position.y = default_leg_separation_y - msg->pose.position.y;
    quad_control.fl_foot_position.z = default_base_link_height - msg->pose.position.z;
    quad_control.fl_foot_in_contact.data = true;

    quad_control.fr_foot_position.x = default_leg_separation_x - msg->pose.position.x;
    quad_control.fr_foot_position.y = -default_leg_separation_y - msg->pose.position.y;
    quad_control.fr_foot_position.z = default_base_link_height - msg->pose.position.z;
    quad_control.fr_foot_in_contact.data = true;

    quad_control.rl_foot_position.x = -default_leg_separation_x - msg->pose.position.x;
    quad_control.rl_foot_position.y = default_leg_separation_y - msg->pose.position.y;
    quad_control.rl_foot_position.z = default_base_link_height - msg->pose.position.z;
    quad_control.rl_foot_in_contact.data = true;

    quad_control.rr_foot_position.x = -default_leg_separation_x - msg->pose.position.x;
    quad_control.rr_foot_position.y = -default_leg_separation_y - msg->pose.position.y;
    quad_control.rr_foot_position.z = default_base_link_height - msg->pose.position.z;
    quad_control.rr_foot_in_contact.data = true;

    return quad_control;
  }

  rclcpp::Publisher<quadruped_msgs::msg::QuadrupedControl>::SharedPtr quadruped_control_pub_;
